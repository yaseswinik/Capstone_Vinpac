...
######################## RESPONSIBLE MACHINE FOR DYNAC_3

dynac_state = 'dynac_3'
rules_copy_dy = rules_copy_20[rules_copy_20['consequents'].astype(str).str.lower().str.contains(dynac_state)]
rules_sorted_dy = rules_copy_dy.sort_values(by=['confidence'], ascending=False)
rules_sorted_dy.head()

######################## RESPONSIBLE MACHINE FOR SCREWCAP_3

screwcap_state = 'Screwcap_3'
rules_copy_sc = rules_copy_20[rules_copy_20['consequents'].astype(str).str.lower().str.contains(screwcap_state)]
rules_sorted_sc = rules_copy_sc.sort_values(by=['confidence'], ascending=False)
rules_sorted_sc.head()


######################## RESPONSIBLE MACHINE FOR Palletiser_2

Palletiser_state = 'Palletiser_2'
rules_copy_pa = rules_copy_20[rules_copy_20['consequents'].astype(str).str.lower().str.contains(Palletiser_state)]
rules_sorted_pa = rules_copy_pa.sort_values(by=['confidence'], ascending=False)
rules_sorted_pa.head()


######################## RESPONSIBLE MACHINE FOR Labeller_3

Labeller_state = 'Labeller_3'
rules_copy_lb = rules_copy_20[rules_copy_20['consequents'].astype(str).str.lower().str.contains(Labeller_state)]
rules_sorted_lb = rules_copy_lb.sort_values(by=['confidence'], ascending=False)
rules_sorted_lb.head()
