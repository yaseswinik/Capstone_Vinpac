...
dynac_state = 'dynac_3'
rules_copy_dy = rules_copy_19[rules_copy_19['consequents'].astype(str).str.lower().str.contains(dynac_state)]
...
rules_copy_sc = rules_copy_19[rules_copy_19['consequents'].astype(str).str.lower().str.contains(screwcap_state)]
...
rules_copy_lb = rules_copy_19[rules_copy_19['consequents'].astype(str).str.lower().str.contains(Labeller_state)]
